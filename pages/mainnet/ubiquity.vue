...
<div>
    ...
    <div class="mt-10">
      ...
      <div
        class="px-0.5 mt-6 grid w-full grid-cols-1 gap-1 md:grid-cols-3 sm:grid-cols-2 xl:gap-[17px]"
      >
        <div class="shadow rounded-md  place-content-between flex">
          <div class="flex flex-col place-content-between py-[24px] pl-[24px] pr-[24px] w-[305px] ">
            <h3 class="text-[19px] text-primary-black font-semibold  leading-[22px]">
              Stabilize
              Liquity Protocol
            </h3>
            <p class="mt-1 text-primary font-medium flex justify-end text-[14px] text-[#1874FF]">
              <a target="_blank" href="https://docs.liquity.org/faq/stability-pool-and-liquidations">- Learn More -</a></p>
          </div>
          <div class="flex items-center bg-[#1874FF] shadow rounded-r-md w-[51px] justify-center ">
        ...
        <div class="shadow rounded-md  place-content-between flex">
          <div class="flex flex-col place-content-between py-[24px] pl-[24px] pr-[20px] w-[305px]">
            <h3 class="text-[19px] text-primary-black font-semibold leading-[22px]">
              Get Passive
              Yield on Your LUSD
            </h3>
          ...
          <div class="flex items-center bg-[#1874FF] shadow rounded-r-md w-[51px] flex justify-center">
        ...
        <div class="px-0.5 mt-6 grid w-full grid-cols-1 gap-1 md:grid-cols-2  xl:gap-[17px]">
            <div class="shadow rounded-lg  place-content-between flex items-center">
                <div class="flex place-content-between">
                    <div class="flex items-center  rounded-r-lg h-[108px] w-[100px] flex justify-center">
                        <div
                            style="background: radial-gradient(42.15% 42.15% at 48.94% 48.94%, #D6DAE0 75.67%, #F0F3F9 100%), #C4C4C4;"
                            class="w-12 h-12 rounded-full flex items-center justify-center border border-[#CCDCF3]"
                            >
                            <div
                                class="w-8 h-8 rounded-full flex items-center justify-center bg-[#00E5DC]"
                            >
                ...
                <div class="flex items-center   rounded-lg h-[108px] w-[51px] flex justify-center">
            <CoinStackIcon class="w-[27px]"/>
             ...
             <div class="shadow rounded-md  place-content-between flex items-center">
                ...
                <div class="flex items-center   rounded-lg h-[108px] w-[190px] flex justify-center">
               <button
        class="mr-4 h-10 w-full text-xs font-semibold bg-[#1874FF] shadow text-white rounded-[4px] hover:bg-primary-blue-hover"
      >
        CLAIM ALL
      </button>
          </div>
